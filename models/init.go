...
// init 初始化
func init() {
	orm.RegisterModel(new(BackendUser), new(Resource), new(Role), new(RoleResourceRel), new(RoleBackendUserRel), new(Tags), new(Category))
}
...
/*func BackendUserRoleRelTBName() string {
	return TableName("backend_user_ilus_roles")
}*/
